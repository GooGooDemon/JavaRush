...
public class Solution {
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        {
            number = new AtomicInteger(count.incrementAndGet());
        ...
        public Thread newThread(Runnable r)
        {
            ...
            String threadName = String.format("%s-pool-%d-thread-%d", threadGroupName, number.get(), threadNumber.incrementAndGet());
